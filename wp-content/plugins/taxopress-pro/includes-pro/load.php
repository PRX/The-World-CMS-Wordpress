...
//include licence
require_once(TAXOPRESS_PRO_ABSPATH . '/includes-pro/classes/licence.php');
//include pro modules
require_once(TAXOPRESS_PRO_ABSPATH . '/includes-pro/modules/taxonomy-synonyms/taxonomy-synonyms.php');
require_once(TAXOPRESS_PRO_ABSPATH . '/includes-pro/modules/linked-terms/linked-terms.php');
require_once(TAXOPRESS_PRO_ABSPATH . '/includes-pro/modules/tag-clouds/tag-clouds.php');
require_once(TAXOPRESS_PRO_ABSPATH . '/includes-pro/modules/related-posts/related-posts.php');
require_once(TAXOPRESS_PRO_ABSPATH . '/includes-pro/modules/post-tags/post-tags.php');
require_once(TAXOPRESS_PRO_ABSPATH . '/includes-pro/modules/autolinks/autolinks.php');
require_once(TAXOPRESS_PRO_ABSPATH . '/includes-pro/modules/autoterms/autoterms.php');
require_once(TAXOPRESS_PRO_ABSPATH . '/includes-pro/modules/autoterms/schedule.php');
require_once(TAXOPRESS_PRO_ABSPATH . '/includes-pro/modules/taxopress-ai/taxopress-ai.php');
require_once(TAXOPRESS_PRO_ABSPATH . '/includes-pro/modules/terms/terms.php');
require_once(TAXOPRESS_PRO_ABSPATH . '/includes-pro/modules/taxonomies/taxonomies.php');
require_once(TAXOPRESS_PRO_ABSPATH . '/includes-pro/modules/taxonomies/class-taxonomies-table.php');
...
// add linked term after terms in dashboard
        ...
        {
            wp_register_style('st-admin-pro', TAXOPRESS_PRO_URL . '/includes-pro/assets/css/pro.css', array(), STAGS_VERSION, 'all');
            wp_register_script('st-admin-pro', TAXOPRESS_PRO_URL . '/includes-pro/assets/js/pro.js', array( 'jquery' ), STAGS_VERSION);
        }
